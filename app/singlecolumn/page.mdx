...
<TableOfContentsItem topic='step 01a -  using a database' label='01a using a database'>
...
<TableOfContentsItem topic='step 01b -  a DB session' label='01b a DB session'>
...
<TableOfContentsItem topic='step 02a -  POST /api/notes to create notes' label='02a POST /api/notes to create notes'>
...
<TableOfContentsItem topic='step 03a -  expose /static/ folder with the CSS style' label='03a expose /static/ folder with the CSS style'>
...
<TableOfContentsItem topic='step 04 -  redirect / to /front/notes' label='04 redirect / to /front/notes'>
